...
urlpatterns=[
    ...
    path('liste/<str:id>/Frais', views.listeFrais, name='listeFrais'),
    ...
    path('listeEtudiantOrdre', views.listeEtudiantOrdre, name="listeEtudiantOrdre"),
    path('listeAnne', views.listeAnne, name="listeAnne"),
    path('listeEtudiantNonOrdre', views.listeEtudiantNonOrdre, name="listeEtudiantNonOrdre")
]